...
import { createRealmSystem } from "../../../../src/runtime/game-layer-babylon-lite/systems/realm-system.js";
...
const unlockADoor = {
  ...
  steps: [
    ...
    { id: "collect-key", label: "Collect Key", criterion: { mode: "event", eventType: "pickup-collected", pickupType: "key", target: 1 } },
