...
viewport over 250 ms after notification processing is complete. The toast SHALL
remain readable within narrow and wide viewports without introducing page
overflow.
...
- **THEN** the exit is cancelled and the new message is shown immediately for a
  new 3-second visible duration
