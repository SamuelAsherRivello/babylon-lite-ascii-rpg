...
- [ ] 1.1 Update the player-grid startup-origin calculation so Center,
...
- [ ] 1.2 Ensure the Babylon Lite game layer resolves that startup origin before
...
- [ ] 1.3 Preserve post-startup camera-mode behavior for movement, resize,
...
- [ ] 2.1 Extend player-grid tests to restart each camera mode, assert the
