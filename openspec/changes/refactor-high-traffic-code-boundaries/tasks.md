...
- [x] 3.3 Keep local development file persistence and deployed localStorage serialization unchanged; verify Confirm, Cancel, reload, and legacy-selection behavior through focused tests and manual Procedural-window checks.
