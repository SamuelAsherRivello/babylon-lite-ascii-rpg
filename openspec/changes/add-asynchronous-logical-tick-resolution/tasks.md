...
- [ ] 2.1 Keep logical tick ordering in the coordinator and ensure systems remain dumb tick consumers with no out-of-order detection or repair logic; verify multi-unit and overlapping-tick fixtures preserve ordered callback delivery.
