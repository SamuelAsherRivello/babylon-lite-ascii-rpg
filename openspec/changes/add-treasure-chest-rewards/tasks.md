...
- [ ] 4.2 Run the production build and inspect the game manually in both realms at Low, Med, and High Chest settings; verify `npm.cmd run build` succeeds and visual glyph state, collision, and Heart collection match the specification.
