...
- Target at least 50 sampled FPS while sprinting in Med worlds on the documented desktop baseline, with all layers enabled and no accumulating simulation lag.
...
- `movement-render-performance`: add the medium-world, both-realm 50 FPS acceptance case.
