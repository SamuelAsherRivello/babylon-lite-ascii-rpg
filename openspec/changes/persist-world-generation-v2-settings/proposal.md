...
- Requires focused store/endpoint tests, existing Node test coverage, a production build, and manual V2 verification of confirm, reload, cancel, and local-storage behavior.
