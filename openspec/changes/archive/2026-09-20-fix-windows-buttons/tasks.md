...
- [x] 2.2 Verify Ascii Settings close control and backdrop behavior, including repeated open/close cycles and glyph-editor interaction, with a focused UI/client check.
- [x] 2.3 Verify Arguments close control and backdrop behavior, including repeated open/close cycles and URL-argument controls, with a focused UI/client check.
...
- [x] 3.1 Add or update the narrowest permitted source/client tests for the discovered failure and verify they pass without modifying Playwright test files unless an approved browser-test command is introduced.
