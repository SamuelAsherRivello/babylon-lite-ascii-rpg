...
- [x] 4.3 Perform manual browser verification with an explicit `randomSeed`: open Dev > Windows > PFX, drag the window, select every listed effect, place repeated previews in the game world, and verify layering, one-shot completion, and window persistence
