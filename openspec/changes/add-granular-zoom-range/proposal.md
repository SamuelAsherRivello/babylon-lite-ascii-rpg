...
The proposed scale is logarithmic rather than linearly spaced: proposed zoom 1 represents 0.1× the current zoom-1 scale, proposed zoom 10 represents the current zoom-10 scale, and proposed zooms 2–9 evenly distribute the multiplicative range between those endpoints. Equal increments therefore apply an equal ratio, not an equal additive cell-size change.
...
- Map displayed zooms 2–9 with equal multiplicative spacing between those endpoint scales.
...
- `zoom-levels`: Change the ten-level mapping, logarithmic spacing, device-default migration, saved-value migration, minimap-equivalent mapping, and camera behavior across displayed zooms 1–10.
