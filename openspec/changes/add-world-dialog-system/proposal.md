...
- Add an available-UI-spaces evaluator that ranks current visible overlay placements around HUD elements, the player, and active enemies.
- Use the same available-UI-spaces result for non-modal Welcome Sign dialogs and modal NPC dialogs while preserving their distinct interaction modes.
...
- Affected systems include the Babylon Lite NPC/object and movement layers, the narrow game/React bridge, React HUD/dialog/window presentation, palette-backed world glyph data, and focused unit/integration tests.
