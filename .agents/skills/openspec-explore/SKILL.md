...
**Mode requirement:** Before beginning any exploration, enter Plan mode with `/plan`. Remain in Plan mode for the duration of this skill unless the user explicitly changes the mode.
