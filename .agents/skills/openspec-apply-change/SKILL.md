...
**Mode requirement:** Before beginning implementation, turn off Plan mode with `/plan off` and continue in Default mode. Do not begin implementation while Plan mode is active.
